...
// Задание
// Напиши функцию countProps(object), которая считает и возвращает количество собственных свойств объекта в параметре object. Используй переменную propCount для хранения 
...
// Метод Object.keys()
// У встроенного класса Object есть несколько полезных методов для работы с объектами. Первый из них это Object.keys(obj), который принимает объект и возвращает
// массив ключей его собственных свойств.Если в объекте нет свойств, метод вернёт пустой массив.
...
// Задание
// Запиши в переменную keys массив ключей собственных свойств объекта apartment, а в переменную values массив всех значений его свойств. Используй методы Object.keys()
// и Object.values().
...
// можно получить используя синтаксис «через точку»,
...
// Функция ищет объект продукта с таким именем
...
// Задание
// Напиши функцию getAllPropValues(propName) которая принимает один параметр propName - имя (ключ) свойства. Функция должна вернуть массив всех значений свойства 
// с таким именем из каждого объекта в массиве products.Если в объектах нет свойства с таким именем, функция должна вернуть пустой массив.
...
// Задание
// Напиши функцию calculateTotalPrice(productName) которая принимает один параметр productName - название товара. Функция должна вернуть общую стоимость 
...
// / /xxxxxxxxxxxxxxxxxxxxxзадача № 33 xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx//
...
// / /xxxxxxxxxxxxxxxxxxxxxзадача № 34 xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx//
// Методы объекта
...
// / /xxxxxxxxxxxxxxxxxxxxxзадача № 35 xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx//
...
// / /xxxxxxxxxxxxxxxxxxxxxзадача № 36 xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx//
...
//   getPotions() {
//     const myArray = this.potions;
//     return myArray;
//   },
//   addPotion(potionName) {
//     const myArray = this.potions;
//     if (myArray.includes(potionName)) {
//       return `Potion ${potionName} is already equipped!`;
//     }

//     return myArray.push(potionName);
//   },
//   removePotion(potionName) {
//     const myArray = this.potions;
//     const potionIndex = myArray.indexOf(potionName);

//     if (potionIndex === -1) {
//       return `Potion ${potionName} is not in inventory!`;
//     }

//     return myArray.splice(potionIndex, 1);
//   },
//   updatePotionName(oldName, newName) {
//     const myArray = this.potions;
//     const potionIndex = myArray.indexOf(oldName);

//     if (potionIndex === -1) {
//       return `Potion ${oldName} is not in inventory!`;
//     }

//    return myArray.splice(potionIndex, 1, newName);
//   },
//   // Change code above this line
// };
// // xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx ответ для бота хххххххххххххххххххххххххххххххххххххххххх
...
// ХХХХХХХХХХХХХХХХХХХХХХХХ   СТРЕЛОЧНАЯ ФУНКЦИЯ    ХХХХХХХХХХХХХХХХХХХХХХХХХХХХХХХХХХХХХХХХХ
// const ret = function(value, number){  // обичная
//     console.log(ret);
// }
// const ret = (value, number)=>{   // стрелочная
//     console.log(ret);
// }